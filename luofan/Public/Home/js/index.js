...
$('.fa-weixin').hover(function(){
	$(this).parent().find('.hover_ewm').addClass('active')
},function(){
	$(this).parent().find('.hover_ewm').removeClass('active')
})
	
	
	$('.header_nav_zx').hover(function(){
...
function closePlace(){
	$('.place_tk').css('display','none');
}

function openPlace(){
	$('.place_tk').css('display','block');
}

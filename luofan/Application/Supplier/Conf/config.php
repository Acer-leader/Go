<?php
return array(
    'MODULE_ALLOW_LIST' => array('Supplier'),
    ...
    'TMPL_PARSE_STRING'  =>array(
		...
		'__JS__' => '/Public/Supplier/Js',
        '__CSS__' => '/Public/Supplier/Css',
        '__IMAGES__' => '/Public/Supplier/Images',
        '__UPLOADS__' => '/Public/Supplier/Uploads',
        '__UEDITOR__' => '/Public/Supplier/Ueditor',
        '__SWF__' => '/Public/Supplier/Swf',
        '__LHG__' => '/Public/Supplier/lhgcalendar',
        '__JqColor__' => '/Public/Supplier/JqColor',
